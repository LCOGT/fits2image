...
# These carry a WCS that only ever describes the dispersion axis, not sky orientation,
# so rotating a long thin spectrum to put "north" up can turn it on its side.
